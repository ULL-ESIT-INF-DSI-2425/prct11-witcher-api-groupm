 ...
 */
routerCazador.post('/', async (req, res) => {
  try {
 ...
 */
routerCazador.get('/', async (req, res) => {
  try {
    let cazador;
    if (req.query.nombre) {
 ...
 */
routerCazador.get('/:id', async (req, res) => {
  try {
 ...
 * @throws error - Si no se proporciona un nombre o si no existe un cazador con ese nombre
 */
routerCazador.patch('/', async (req, res) => {
  if (!req.query.nombre) {
 ...
 */
routerCazador.patch('/:id', async (req, res) => {
  if (!req.body) {
    res.status(400).send('Los campos a modificar deben ser proporcionados en el cuerpo de la solicitud');
    return;
  }
 ...
 * @throws error - Si no se proporciona un nombre o si no existe un cazador con ese nombre
 */
routerCazador.delete('/', async (req, res) => {
  if (!req.query.nombre) {
    res.status(400).send("El nombre del cazador a eliminar debe ser proporcionado");
    return;
  }
